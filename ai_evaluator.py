...
1. Nível de Senioridade e Experiência:
   ...
   - REJEIÇÃO OBRIGATÓRIA DE SÉNIOR (+3 / +5 / 8+ ANOS / A FEW YEARS): Se a vaga exigir ou mencionar expressamente 3+, 4+, 5+, 8+ anos (ex: "3+ of experience", "+3 years", "8 or more years", "a few years in", "deep experience", "staff/principal"), MESMO QUE AFIRME que "competência importa mais do que anos" ou "years is just a reference point", ou cargos de liderança (Lead, Senior, Principal, Head, Gestor, Staff, redes freelancer sénior como Toptal), DEVES OBRIGATORIAMENTE REJEITÁ-LA (`is_suitable: false`, `fit_score: 0`, `seniority_detected: "Sénior"` ou `"Mid-Senior"`, `reasoning: "Exige experiência profissional prévia de nível pleno/sénior"`).
