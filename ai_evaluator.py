...
2. Adequação da Área e Tipo de Oportunidade: A vaga deve ser um emprego formal ou estágio técnico (IA, Machine Learning, Data Science, Data Engineering, Python Developer, Software Engineer). Rejeita OBRIGATORIAMENTE oportunidades de crowdsourcing/microtarefas/gravação de vídeo/áudio doméstico (ex: Toloka, Appen, Outlier, Remotasks, "record daily routine", "not a job", "get paid per task") e vagas puramente de negócio/administrativas (ex: Vendas, Marketing, RH) sem componente técnica (`is_suitable: false`, `fit_score: 0`, `reasoning: "❌ Rejeitada por IA: Microtarefas/Crowdsourcing não elegível como emprego formal"`).
