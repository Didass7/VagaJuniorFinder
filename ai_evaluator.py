...
1. Nível de Senioridade e Experiência:
   ...
   - Termos como "conhecimento prático", "familiaridade", "experiência académica" ou estágios curriculares/profissionais são totalmente compatíveis. NÃO rejeites estágios ou programas para recém-licenciados por mencionarem projetos práticos.
   - REJEIÇÃO OBRIGATÓRIA DE EXPERIÊNCIA PROFISSIONAL PRÉVIA / SÉNIOR: Se a vaga exigir expressamente experiência profissional prévia comprovada na função (ex: "mínimo de 2 anos de experiência profissional", "experiência profissional mínima de dois anos", "2+ years of professional experience", "3+ anos", "pleno-sénior", "mid-senior", "Nível de experiência: Pleno-sênior", "Mid-Senior", "Pleno", "Requisitos adicionados pelo anunciante com 2+ anos"), ou se exigir 3+, 4+, 5+, 8+ anos, MESMO QUE AFIRME que "competência importa mais do que anos", ou cargos de liderança (Lead, Senior, Principal, Head, Gestor, Staff), DEVES OBRIGATORIAMENTE REJEITÁ-LA (`is_suitable: false`, `fit_score: 0`, `seniority_detected: "Mid-Level"` ou `"Sénior"`, `reasoning: "Exige experiência profissional mínima na função incompatível com perfil júnior"`).
   - ATENÇÃO A GRAUS ACADÉMICOS: O candidato possui {profile.degree}. Se a vaga exigir expressamente Mestrado (Master's / MSc / Nível 7) como requisito obrigatório e NÃO aceitar Licenciatura (BSc / Degree / Licenciado), deves OBRIGATORIAMENTE REJEITÁ-LA (`is_suitable: false`, `fit_score: 0`, `reasoning: "Exige Mestrado, incompatível com o grau de Licenciatura"`). A menção de "Degree / Master for graduates" refere-se apenas a formação universitária e NÃO torna uma vaga júnior se a mesma exigir simultaneamente anos de experiência prévia (+2 / +3 / +5 / +8 anos ou Pleno-sênior).
   - Se a vaga NÃO exigir anos de experiência profissional prévia obrigatórios, for estágio ou de nível de entrada/júnior acessível, deves considerá-la ADEQUADA (`is_suitable: true`, `seniority_detected: "Júnior"` ou `"Recém-licenciado"`, `fit_score: 65% a 90%`).
