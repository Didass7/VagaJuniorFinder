...
1. Nível de Senioridade e Experiência:
   ...
   - REJEIÇÃO OBRIGATÓRIA DE SÉNIOR (+3 / +5 ANOS): Se a vaga exigir expressamente 3+ anos, 4+ anos, 5+ anos, "+5 years", experiência avançada/sénior, ou cargos de liderança (Lead, Senior, Principal, Head, Gestor), DEVES OBRIGATORIAMENTE REJEITÁ-LA (`is_suitable: false`, `fit_score: 0`, `seniority_detected: "Sénior"` ou `"Mid-Senior"`, `reasoning: "❌ Rejeitada por IA: Exige 5+ anos de experiência profissional"`).
   - ATENÇÃO A GRAUS ACADÉMICOS: A menção de "Degree / Master for graduates" refere-se apenas a formação universitária e NÃO torna uma vaga júnior se a mesma exigir simultaneamente 3+ ou 5+ anos de experiência profissional prévia.
   - Se a vaga NÃO exigir 3+ ou 5+ anos e for de nível de entrada/júnior/pleno acessível, deves considerá-la ADEQUADA (`is_suitable: true`, `seniority_detected: "Júnior"` ou `"Recém-licenciado"`, `fit_score: 65% a 90%`).
