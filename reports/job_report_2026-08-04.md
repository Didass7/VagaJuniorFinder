...
**Empresa:** Cambridgeconsultantslimited &nbsp;|&nbsp; **Localização:**  &nbsp;|&nbsp; **Fonte:** `Arbeitnow`
**Match:** `75.0%` &nbsp;|&nbsp; `Presencial / Híbrido` &nbsp;|&nbsp; **Nível:** `Junior / Entry Level`

**Stack:** `python` `langchain` `git`

> <p></p> <h3><strong><span data-contrast="auto">Introduction </span></strong><span data-ccp-props="{}">&nbsp;</span></h3> <p><span data-contrast="auto">Are you passionate about designing and developing User Interfaces? </span><span data-ccp-props="{}">&nbsp;</s...

[Candidatar — Cambridgeconsultantslimited](https://www.arbeitnow.co.uk/jobs/companies/cambridgeconsultantslimited/graduate-javascript-typescript-ui-engineer-2026-start-354798)
...
### [Data Engineer III](https://www.arbeitnow.co.uk/jobs/companies/primerio/data-engineer-iii-united-kingdom-67090)
**Empresa:** Primer.io &nbsp;|&nbsp; **Localização:** United Kingdom &nbsp;|&nbsp; **Fonte:** `Arbeitnow`
**Match:** `65.0%` &nbsp;|&nbsp; `Presencial / Híbrido` &nbsp;|&nbsp; **Nível:** `Geral / Pleno`

**Stack:** `python` `machine learning`

> An Introduction to PrimerPrimer is the unified infrastructure for global payments. We give finance and payments teams the visibility and control to reduce complexity, improve performance, and capture more revenue - all from a single platform.Backed by Sofina,...

[Candidatar — Primer.io](https://www.arbeitnow.co.uk/jobs/companies/primerio/data-engineer-iii-united-kingdom-67090)
...
### [AI Engineer – Model Training & Deployment](https://www.arbeitnow.com/jobs/companies/clera/ai-engineer-model-training-deployment-munich-54331)
**Empresa:** Clera &nbsp;|&nbsp; **Localização:** Munich &nbsp;|&nbsp; **Fonte:** `Arbeitnow`
**Match:** `60.0%` &nbsp;|&nbsp; `Presencial / Híbrido` &nbsp;|&nbsp; **Nível:** `Geral / Pleno`

**Stack:** `machine learning`

> About the RoleJoin an early-stage industrial robotics startup in Munich as ajunior AI Engineeron a focused ML and robotics team. You'll work on the core deep learning stack that enables robotic work cells to perceive and act in real industrial environments — c...

[Candidatar — Clera](https://www.arbeitnow.com/jobs/companies/clera/ai-engineer-model-training-deployment-munich-54331)
...
- **Python**: `13 vagas` (27.1%)
- **Machine Learning**: `7 vagas` (14.6%)
- **Sql**: `4 vagas` (8.3%)
- **Llm**: `3 vagas` (6.2%)
- **Git**: `2 vagas` (4.2%)
- **Langchain**: `1 vagas` (2.1%)
- **Rag**: `1 vagas` (2.1%)
- **Fastapi**: `1 vagas` (2.1%)
...
*VagaJuniorFinder | Gerado a 04/08/2026 23:49.*